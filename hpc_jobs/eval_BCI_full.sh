#!/bin/bash
#SBATCH --job-name=pytorch_cyclegan_pix2pix_eval_BCI
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH -p ampere_gpu
#SBATCH --gres=gpu:1
#SBATCH -o /data/antwerpen/212/vsc21214/projects/pytorch-CycleGAN-and-pix2pix/logs/eval_BCI.%j.out
#SBATCH -e /data/antwerpen/212/vsc21214/projects/pytorch-CycleGAN-and-pix2pix/logs/eval_BCI.%j.err

# eval_BCI_full.sh
# Runs evaluate.py on BCI inference outputs.
